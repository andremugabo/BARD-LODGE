...
CREATE TABLE CLOSING_SALES_STOCK(
    CSS_ID INT PRIMARY KEY AUTO_INCREMENT,
    S_REF VARCHAR(255),
    P_ID INT,
    P_QTY INT,
    P_PPRICE DECIMAL(10, 2),
    CSS_DATE DATE,
    FOREIGN KEY (S_REF) REFERENCES SESSIONS(S_REF),
    FOREIGN KEY (P_ID) REFERENCES PRODUCTS(P_ID)
);

CREATE TABLE CLOSING_GENERAL_STOCK(
    CGS_ID INT PRIMARY KEY AUTO_INCREMENT,
    S_REF VARCHAR(255),
    P_ID INT,
    P_QTY INT,
    P_PPRICE DECIMAL(10, 2),
...
CREATE TABLE CLOSING_SALES_REPORT(
    ...
    P_QTY INT,
    P_PPRICE DECIMAL(10, 2),
    P_SPRICE DECIMAL(10, 2),
    CSR_DATE DATE,
    FOREIGN KEY (S_REF) REFERENCES SESSIONS(S_REF),
    FOREIGN KEY (UNITY_ID) REFERENCES UNITY(UNITY),
    FOREIGN KEY (P_ID) REFERENCES PRODUCTS(P_ID)
);
...
CREATE TABLE EXPENSES (
    ...
    EXP_DESCRIPTION VARCHAR(255) NULL,
    EXP_AMOUNT FLOAT NOT NULL,
    EXP_DATE DATE NOT NULL,
    EXP_STATUS ENUM('1', '0') DEFAULT '0'
);
