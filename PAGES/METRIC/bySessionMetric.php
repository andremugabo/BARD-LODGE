...
<div class="container-fluid section-title d-flex">
    ...
    <div class="s-btn text-end col-6">
        ...
        <button type="button" class="btn btn-sm btn-danger" onclick="window.location.href='session.php'">BACK</button>
...
function displayTimeAgo($timestamp) {
    ...
    if ($yearsAgo > 0) {
        ...
        return "Just now";
            ...
            $metricObj->setSId($s_id);
            $getMetric = $metricDao->selectMetricBySession($metricObj);
