...
<div class="col">
    <div class="card">
        <div class="card-header">
            <caption>Non&nbsp;Session&nbsp;Metric</caption>
        </div>
        <div class="card_metric card-body overflow-auto">
        ...
        function displayTimeAgo($timestamp) {
            ...
            $getMetric = $metricDao->selectMetricByNonSession();
            ...
            <div class="metric_card col-lg-3 d-inline-block">
                <section class="real_card card">
                    <div class="card-header user-header alt bg-dark">
                        <div class="media ">
                            ...
                            <div class="media-body">
                                <h5 class="text-light display-6" style="font-size: 12px;">
                                    <?=$items['FIRSTNAME']." ".$items['LASTNAME']?></h5>
                                <p class="text-white" style="font-size: 12px;"><?=$items['E_ROLE']?></p>
                            </div>
                        </div>
                    </div>
