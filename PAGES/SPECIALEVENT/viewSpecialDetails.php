            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Kitchen special order form</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="title_o m-1 p-1 row">
                            <span>KITCHEN SPECIAL ORDER FORM</span>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="p-1">
                                ...
                                <a type="submit" target="_blank" name="PlaceOrder" class="btn btn-warning "
                                    href='../PDF/pdf_kSpecial.php?o_ref=<?=$_GET['o_ref']?>'>Print</a>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-sm table-hover">
                                ...
                                <tbody>
                                    ...
                                    $specialObj = new Special;
                                    $specialObj->setORef($_GET['o_ref']);
                                    $orderInfo = $specialDaoObj->selectSpecialById($specialObj);
                                    // echo$orderInfo['O_ID'];
                                    $specialDetails->setOId($specialInfo['O_ID']);
