...
$pdf->Cell(175,20,'BARMAN ORDER',0,1,'C',true);
// $pdf->Cell(25,20,'',0,1);
...
$pdf->Cell(18,10,'CODES ',1,0,'C',true);
$pdf->Cell(180,10,'ORDERS ',1,0,'C',true);
$pdf->Cell(15,10,'TOTAL',1,1,'C',true);
...
if($products->selectCategoryDrinks()):
	...
	//  $pdf->Cell(30,10,$key['cat_name'],1,0,'C');
	 $pdf->Cell(60,10,$key['p_name'],1,0,'C');
	 $pdf->Cell(18,10,$key['p_code'],1,0,'C');
	 $pdf->Cell(180,10,'',1,0,'C');
