...
$pdf->Cell(200,10,'CLOSED GENERAL STOCK',0,1,'L');
$pdf->Cell(150,10,'Kigali, KG 730 ST ',0,1,'L');
$pdf->Cell(35,10,'TIN:122270330',0,1,'L');
$pdf->Cell(35,10,'Tel:(+250)Tel:(+250)782-512-600',0,1,'L');
...
require_once"../../API/DAO/Closing_general_stockDao.php"; 
$gStockDao = new Closing_general_stockDao();
$gStockObj = new Closing_general_stock();
$s_ref = $_GET['s_ref'];
$gStockObj->setSRef($s_ref);
$currentStock =$gStockDao->selectGStockBySid($gStockObj);
