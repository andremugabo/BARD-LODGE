...
$pdf->Cell(45,5,'X-Lounge / CLIENT BILL',0,1,'C');
...
$total = 0;
$sum = 0;
if($billDetails->selectRef($b_reference)):
foreach ($billDetails->selectRef($b_reference) as $billDetail) {  $num++; 
