...
<div class="principal-row justify-content-center row">
    ...
    <div class="card-principal card bg-success m-2">
        <a href="<?php base(); ?>employees" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-danger m-2">
        <a href="<?php //base(); ?>category" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-warning m-2">
        <a href="<?php //base(); ?>types" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-info m-2">
        <a href="<?php // base(); ?>products" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-danger m-2">
        <a href="<?php //base(); ?>price" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-info m-2">
        <a href="<?php //base(); ?>sessions" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-warning m-2">
        <a href="<?php //base(); ?>purchas" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-success m-2">
        <a href="<?php //base(); ?>stock" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-primary m-2">
        <a href="<?php //base(); ?>expense" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-secondary m-2">
        <a href="<?php //base(); ?>metric" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-danger m-2">
        <a href="<?php //base(); ?>settings" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
    ...
    <div class="card-principal card bg-info m-2">
        <a href="<?php //base(); ?>reports" style="text-decoration:none;">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
