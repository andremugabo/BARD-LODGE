...
<div class="container-fluid section-title d-flex mb-2">
    ...
    <div class="s-btn text-end col-6">
        ...
        &nbsp; -->
        <button type="button" class="btn btn-sm btn-danger " onclick="window.location.href='gStock.php'">Back</button>
    </div>
</div>
    ...
    <div class="s-title text-start col-lg-6 p-2 ">
        <div class="card">
            <div class="card-header">
                <strong>Filter&nbsp;Purchased&nbsp;Products</strong>
            </div>
...
<div class="col" style="min-height: 100vh;">
    <div class="card">
        <div class="card-header">
            <strong class="card-title">Purchased&nbsp;Products&nbsp;Table</strong>
        </div>
        <div class="card-body overflow-auto" style="min-height: 100vh; overflow:auto;">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    $purchaseObj->setSId($_SESSION['currentSession']);
                    $selectProduct =$purchaseDao->selectPurchaseByFilterAndSession($productByFilter,$purchaseObj);
                    $num = 0;
