...
<div class="col">
    <div class="card">
        <div class="card-header">
            <strong class="card-title">List of Purchased Products</strong>
        </div>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <button type="button" class="btn btn-success btn-sm mb-1"
                                onclick="window.location.href='purchase.php?s_id=<?=$item['S_ID']?>'">View&nbsp;Report</button>&nbsp;

                            <button type="button" class="btn btn-warning btn-sm mb-1"
                                onclick="window.location.href='../PDF/pdf_purchase.php?s_id=<?=$item['S_ID']?>'"><img
