...
<div class="title_bar btn-primary d-flex">
    <h2>All&nbsp;Daily&nbsp;Sales</h2>
</div>
<div class="col">
    <div class="card">
        ...
        <div class="card-body overflow-auto">
            <table class="table align-middle mb-0 bg-white table-striped table-sm table-hover">
                ...
                $selectProduct =$orderDetailsDao->selectUnityByAll($orderDetailsObj);
               ...
               if($selectProduct):
                        foreach($selectProduct as $items){$num++;
                            ...
                            $getSales = $orderDetailsDao->selectSalesForAll($orderDetailsObj);
                            if($getSales != null):
