...
<div class="col">
    <div class="card">
        <div class="card-header">
            <strong class="card-title">List of Products of Closed General Stocks</strong>
        </div>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <button type="button" class="btn btn-success btn-sm mb-1"
                                onclick="window.location.href='closedGeneral.php?s_ref=<?=$item['S_REF']?>'">View&nbsp;Report</button>&nbsp;

                            <button type="button" class="btn btn-warning btn-sm mb-1"
                                onclick="window.location.href='../PDF/pdf_closedGeneralReport.php?s_ref=<?=$item['S_REF']?>'"><img
