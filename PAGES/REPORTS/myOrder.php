...
if(isset($_POST['viewSales'])){
    ...
    if(!empty($paymentMode)){
      ...
      $byPaymentMode = "AND  orders.payment_mode = '".$paymentMode."'";
...
<div class=" m-2 p-2 " style="background: #0dcaf0;">
    <form class="row gx-3 gy-2 align-items-center mb-4 mt-2" action="" method="POST">
        ...
        <!-- <div class="col-sm-3">
            <label class="visually-hidden" for="specificSizeSelect">Preference</label>
            <select class="form-select" name="sub_type" id="specificSizeSelect">
                <option selected value="">All&nbsp;Subsession&nbsp;Type</option>
    ...
    <div class="card">
        ...
        <div class="card-body overflow-auto">
            <table class="table align-middle mb-0 bg-white table-striped table-sm table-hover">
                ...
                $selectProduct =$orderDao->selectPaymentMode($orderObj,$byPaymentMode);
                $num = 0;
                $sum = 0;
                if ($selectProduct):
