...
<div class="container-fluid section-title d-flex">
    <div class="s-title text-start col-3">
        <h2>Barman&nbsp;Received&nbsp;Products&nbsp;Reports</h2>
    </div>
...
<div class="col">
    <div class="card">
        <div class="card-header">
            <strong class="card-title">List of Products Received by the Barman</strong>
        </div>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <button type="button" class="btn btn-success btn-sm mb-1"
                                onclick="window.location.href='received.php?s_id=<?=$item['S_ID']?>'">View&nbsp;Report</button>&nbsp;

                            <button type="button" class="btn btn-warning btn-sm mb-1"
                                onclick="window.location.href='../PDF/pdf_received.php?s_id=<?=$item['S_ID']?>'"><img
