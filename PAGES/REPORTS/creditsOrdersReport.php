...
<div class="col">
    <div class="card">
        <div class="card-header">
            <strong class="card-title">List&nbsp;Of&nbsp;Debt&nbsp;Orders&nbsp;By&nbsp;Sessions </strong>
        </div>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <button type="button" class="btn btn-success btn-sm mb-1"
                                onclick="window.location.href='debtOrder.php?s_id=<?=$item['S_ID']?>'">View&nbsp;Report</button>&nbsp;
