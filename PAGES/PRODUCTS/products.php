                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><button type="button btn-sm" title="Edit Employee Info"
                                ...
                                onclick="window.location.href='editProduct.php?edit=<?=$item['P_ID']?>'"><img
                                ...
                                onclick="window.location.href='../../API/CONTROLlER/productsController.php?action=insert&e_id=<?=$item['P_ID']?>'"><img
