...
<div class="container-fluid section-title d-flex mb-2">
    ...
    <div class="s-btn text-end col-7">
        ...
        <button type="button" class="btn btn-sm btn-warning text-white" data-bs-toggle="modal"
            data-bs-target="#employeeModal">Insert&nbsp;Products&nbsp;Type</button>
        &nbsp;
...
<div class="col">
    <div class="card">
        <div class="card-header">
            <strong class="card-title">Products Types Table</strong>
        </div>
        <div class="card-body overflow-auto">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php 
                    $type = new ProductTypeDao();
                    $selectType =$type->selectProductType();
                    $num = 0;
                    // print_r($selectType);
                    if ($selectType != null):
                    foreach ($selectType as $item) {  $num++;?>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><button type="button btn-sm" title="Edit Price Info"
                                ...
                                onclick="window.location.href='editProductType.php?edit=<?=$item['PT_ID']?>'"><img
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../../API/CONTROLLER/ProductTypeController.php?action=insert" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="p_name" class="col-form-label">Product&nbsp;Type:</label>
